...
The code below does not pretend to use best practices in programming or MCTS implementation. This playground is to be perceived as a proof of concept example of how the algorithm works.
