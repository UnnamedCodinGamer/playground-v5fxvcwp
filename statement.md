...
The code below does not pretend to use best practices and can be optimized. This playground is to be perceived as a proof of concept writeup that demonstrates the working of MCTS.
